        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-lg-offset-1 col-sm-push-6 col-sm-6 text-center">
                    ...
                    <p class="lead">Desde aquí podrá ingresar a su cuenta de correo @<?php 
echo preg_replace('/^www\\./', '', $_SERVER['HTTP_HOST']);
?> a través de una interfaz moderna y amigable.</p>
                    <a class="btn-2 btn-2a" href="http://<?php 
echo preg_replace('/^www\\./', '', $_SERVER['HTTP_HOST']);
?>/webmail" role="button">Ir al Webmail Pro</a>
                </div>
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4">
                                <h3>Inducción</h3>
                                <p>Material de ayuda para realizar operaciones frecuentes en su cuenta de hosting como subir su sitio web, crear correos corporativos @<?php 
echo preg_replace('/^www\\./', '', $_SERVER['HTTP_HOST']);
?>, etc.</p>
